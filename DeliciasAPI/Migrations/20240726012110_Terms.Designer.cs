...
namespace DeliciasAPI.Migrations
{
    ...
    [Migration("20240726012110_Terms")]
    partial class Terms
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Terms", b =>
                {
                    b.Property<int>("IdTerms")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTerms"), 1L, 1);
            ...
            modelBuilder.Entity("Domain.Entities.TermsItem", b =>
                {
                    b.Property<int>("IdTermsItem")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdTermsItem"), 1L, 1);

                    b.Property<string>("Term")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("TermsIdTerms")
                        .HasColumnType("int");

                    b.HasKey("IdTermsItem");

                    b.HasIndex("TermsIdTerms");
            ...
            modelBuilder.Entity("Domain.Entities.TermsItem", b =>
                {
                    b.HasOne("Domain.Entities.Terms", null)
                        .WithMany("TermsItem")
                        .HasForeignKey("TermsIdTerms");
                });
